...
function loadTrainers(){
    ...
    let table = document.getElementById('table_trainers').getElementsByTagName('tbody')[0];
    ...
    deleteNode.classList.add("btn")
    deleteNode.classList.add("btn-primary");
    deleteNode.setAttribute("onclick","addTrainer(this)")
...
function pick(ctl) {
    ...
    let fnNode = document.createTextNode(f);
    let lnNode = document.createTextNode(l);
    let sNode =document.createTextNode(s);
    let deleteNode=document.createElement('button')
    ...
    $(editRow).remove();
        ...
        let tb=document.getElementById("table_trainers");
        ...
        for(i=1;i<tr.length;i++){
          ...
          let  td1=tr[i].getElementsByTagName("td")[1];
           ...
           let td3=tr[i].getElementsByTagName("td")[3];
            ...
            let stemp=td2.textContent;
               
            if(f==ftemp && l==ltemp && s==stemp){
               btn= td3.children;
